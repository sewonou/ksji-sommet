 ...
 */
final class Version20200609114807 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking CHANGE booker_id booker_id INT DEFAULT NULL, CHANGE hotel_id hotel_id INT DEFAULT NULL');
